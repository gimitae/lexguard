            ...
            <form onSubmit={handleSubmit} className="space-y-5 flex-1 flex flex-col">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-600 focus:outline-none bg-slate-50 focus:bg-white transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-600 focus:outline-none ${currentUser ? 'bg-slate-100 text-slate-500' : 'bg-slate-50 focus:bg-white'}`}
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-600 focus:outline-none bg-slate-50 focus:bg-white"
                >
              ...
              <div className="flex-1">
                ...
                <textarea
                  ...
                  className="w-full h-full min-h-[160px] px-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-600 focus:outline-none bg-slate-50 focus:bg-white resize-none"
              ...
              <button
                ...
                className={`w-full py-4 mt-4 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 transition-all shadow-lg flex items-center justify-center gap-2 ${isSubmitting ? 'opacity-50' : ''}`}
              >
                <Send className="w-5 h-5" />
                {isSubmitting ? '전송 중...' : t('support.form.submit')}
              </button>
            </form>
          </div>
